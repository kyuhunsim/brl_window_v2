...
g++ -shared -o libpneumatic_simulator.so -fPIC pneumatic_simulator.cpp pneumatic_CT.cpp soft_actuator.cpp soft_actuator_wrapper.cpp
g++ -shared -o libpneumatic_simulator_pred.so -fPIC pneumatic_simulator.cpp pneumatic_CT.cpp soft_actuator.cpp soft_actuator_wrapper.cpp
