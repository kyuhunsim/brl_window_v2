...
const ValveModelParams CHAMBER_POS_PARAMS = {
    0.188145896982, 50.3624948166, 0.169788145741, 9.03160010117e-05, 2.97715497185e-08,
    1175140.68532, 1.76705466662, 0.24397522925, 47.0886174595,
    11, 0.6, 11, 0.6
};
const ValveModelParams CHAMBER_NEG_PARAMS = {
    0.240627143009, 72.4457093622, 0.151802760468, 0.000246213223122, 1.58612321578e-08,
    22518.7854171, 392.113987936, 0.306598602325, 10432.1188685,
    12.1155986251, 0.6, 23.723501383, 0.6
};
const ValveModelParams ACT_POS_IN_PARAMS = {
    0.230846620442, 38.6902619653, 0.0601595518278, 0.000145599275857, 5.08721337695e-07,
    92630.1427453, 1.81224900849, 0.119325669873, 16569.4373027,
    11, 0.6, 11, 0.6
};
const ValveModelParams ACT_POS_OUT_PARAMS = {
    0.195265322902, 48.1148913527, 0.192372429861, 0.000211639175388, 5.31175222703e-06,
    12807.2539316, 0.490956755232, 0.0984520040551, 214.531045128,
    11, 0.6, 11, 0.6
};
const ValveModelParams ACT_NEG_IN_PARAMS = {
    0.164867923352, 66.2944801927, 0.135563955672, 6.30274259455e-05, 3.40430738922e-07,
    138744.803599, 1.14010781152, 1.08889347611, 15957.2736753,
    11, 0.6, 11, 0.6
};
const ValveModelParams ACT_NEG_OUT_PARAMS = {
    0.233853418746, 37.0694353733, 0.00825757291887, 0.000299997119448, 2.60777108979e-05,
    869.445481804, 1.23406057841, 1.51629568926, 45099.2468706,
    11, 0.6, 50, 0.6
};
...
PneumaticCT::PneumaticCT() {
    ...
    leak_pos_atm = 1.1717650150589065e-08;
    leak_neg_atm = 7.172437082833248e-09;
    leak_cross = 0.0;
